...
class SSDWideLiteVGG16(torch.nn.Module):

    def __init__(self, input_channels, num_classes, num_bboxes):
        super(SSDWideLiteVGG16, self).__init__()
        ...
        **************************'''      
        ...
        self.block10_conv2 = torch.nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1)
        ...
        self.block11_conv2 = torch.nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1)
